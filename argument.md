...
- [Kur'an'ın İlahi Kaynağı Argümanı](#kuranın-i̇lahi-kaynağı-argümanı)
  ...
  - [3. Öncül 2b: Kur'an'daki Çağının Ötesindeki Bilgiler](#3-öncül-2b-kurandaki-çağının-ötesindeki-bilgiler)
    - [3.1 Bilimsel İçerik](#31-bilimsel-i̇çerik)
...
**Bağımsızlık:**
- **Senaryo 1:** O dönemde **erişilebilir kaynaklarda bulunmayan** bilgiler olmalı
- **Senaryo 2:** Bilgi **mevcut kaynaklarda var, ancak:**
  - Metin, bu **karışık havuzdan sistematik olarak doğruları seçiyor**
  - Bu **seçicilik tesadüfle açıklanamayacak kadar tutarlı**
  - Dönemin **yaygın yanlışlarından aktif olarak kaçınılmış**
...
**Örnek Seçimi Hakkında:**
Kur'an 6236 ayetten oluşur ve büyük çoğunluğu hukuki hükümler, ahlaki öğütler, peygamber kıssaları ve teolojik açıklamalar içerir. Bu bölümde incelenen örnekler, Kur'an'ın tamamından değil, yalnızca **doğal dünyaya ilişkin test edilebilir iddialarda bulunan** ayetlerden seçilmiştir. Seçim kriterleri yukarıdaki "Değerlendirme Kriterleri" bölümünde tanımlanmıştır: tarihsel imkansızlık, spesifiklik, sistematik doğruluk ve bağımsızlık. Bu filtreleri geçemeyen iddialar (örneğin embriyoloji gibi dönemin bilgisiyle açıklanabilecek olanlar) "Dahil Edilmeyen İddialar" bölümünde tartışılmıştır.
...
**Alternatif Açıklamaların Reddi:**
- Basit gözlem iddiası: Derin denizin katmanlı karanlık yapısı dalış teknolojisi olmadan bilinemez
- Tahmin iddiası: "Karanlıklar üst üste" ifadesi katmanlı yapıyı net tarif ediyor
...
**Neden yetersiz:**
- **Manuskript delilleri:** 7. yüzyıla tarihlenen manuskriptler mevcut metinle aynı (Birmingham, Tübingen, Topkapı örnekleri yukarıda sunuldu).
...
- **Matematiksel düzen:** Metindeki matematiksel örüntüler, herhangi bir değişikliğin bu düzeni bozacağını gösterir.
...
- Kalbin düşüncenin ve duygunun merkezi olduğu iddiası (beyin değil) [^aristotle_heart]

**Galen'in hataları:**
- Kanın karaciğerde üretilip tüketildiği (dolaşım sistemi yok) [^galen_blood]
- Uterusun iki bölmeli olduğu [^galen_anatomy]
- Beyin boşluklarında "ruhların" bulunduğu [^galen_brain]
